...
public class ProductCRUDController {
	...
	@PostMapping("/add") // vajag nodrosinat validaciju jo seit ievada/maina datus
	public String postAddNewProduct(@Valid Product product, BindingResult result, Model model) { // pievieno valid
		
		if(result.hasErrors()) { //ja ievades datos ir kads validacijas parkapums
			return "add-new-product-page";
		}
